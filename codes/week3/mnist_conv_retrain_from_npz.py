...
with tf.name_scope('conv1'):
    weights=tf.Variable(param['conv1_w'], 
                        dtype=tf.float32,
                        trainable=False,
                        name='weights')

    biases1=tf.Variable(param['conv1_b'],
                       dtype=tf.float32,
                       trainable=False,
                       name='biases')
    ...
    conv=tf.nn.conv2d(input=X_, 
                      ...
                      strides=[1,1,1,1], 
                      padding='SAME')
    conv = tf.nn.bias_add(conv, biases1)
...
with tf.name_scope('conv2'):
    weights=tf.Variable(param['conv2_w'],
                        dtype=tf.float32,
                        trainable=False,
                        name='weights')
    
    biases=tf.Variable(param['conv2_b'],
                       dtype=tf.float32,
                       trainable=False,
                       name='biases') 
...
with tf.name_scope('fc1'):
    weights=tf.Variable(param['fc1_w'], 
                        dtype=tf.float32,
                        trainable=False,
                        name='weights')
    
    biases=tf.Variable(param['fc1_b'], 
                       dtype=tf.float32,
                       trainable=False,
                       name='biases') 
...
with tf.name_scope('fc2'):
    weights=tf.Variable(param['fc2_w'],
                        dtype=tf.float32,
                        name='weights')
    
    biases=tf.Variable(param['fc2_b'], 
                       dtype=tf.float32,
                       name='biases') 
